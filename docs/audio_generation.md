...
resp, err := client.AudioGeneration.Create(ctx, &doubaospeech.AudioGenerationCreateRequest{
    ...
    TextPrompt: "Read this short Chinese voiceover in a natural and warm narrator voice: Hello, this is a voiceover sample generated by the Doubao Audio Generation API.",
...
go run ./examples/audio_generation \
  -prompt "Read this short Chinese voiceover in a natural and warm narrator voice: Hello, this is a voiceover sample generated by the Doubao Audio Generation API." \
  -format mp3 \
