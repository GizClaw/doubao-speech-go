...
func main() {
	...
	flag.StringVar(&prompt, "prompt", "Read this short Chinese voiceover in a natural and warm narrator voice: Hello, this is a voiceover sample generated by the Doubao Audio Generation API.", "Prompt or text content")
	...
	flag.StringVar(&outputPath, "output", "", "Output audio file path")
	...
	if outputPath == "" {
		outputPath = "audio_generation_output." + outputExtension(format)
	}
